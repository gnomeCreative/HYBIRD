...
enum ProblemName {NONE, SHEARCELL, AVALANCHE, DRUM, NET, BARRIER, 
    ...
    HOURGLASS, IERVOLINO,IERVOLINO_2D, IERVOLINO_CYLINDERTEST, HEAP, TRIAXIAL, JOP, WILL, WILL_SETTLING, MANGENEY, GRAY, ESERCITAZIONE, FILIPPO_SILOS, HK_SMALL, HK_LARGE, KELVIN, SHEAR_CELL_2022};
