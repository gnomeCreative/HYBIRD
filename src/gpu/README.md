...
Due to time constraints 3/4 of the model has been ported to execute using CUDA, meaning that the GPU LBM model (including coupling and free surface) is able to execute, whilst the DEM model remains executing using the original CPU code.
