...
# CC Compiler Flags
CCFLAGS=-fopenmp -w -pg -O0
CXXFLAGS=-fopenmp -w -pg -O0
...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/hybird.exe: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/hybird.exe ${OBJECTFILES} ${LDLIBSOPTIONS} -fopenmp -pg -g -ggdb

${OBJECTDIR}/DEM.o: DEM.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DEM.o DEM.cpp
...
${OBJECTDIR}/LB.o: LB.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LB.o LB.cpp

${OBJECTDIR}/elmt.o: elmt.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/elmt.o elmt.cpp

${OBJECTDIR}/hybird.o: hybird.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hybird.o hybird.cpp

${OBJECTDIR}/myvector.o: myvector.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/myvector.o myvector.cpp
